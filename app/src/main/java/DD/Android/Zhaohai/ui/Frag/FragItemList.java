...
import DD.Android.Zhaohai.ui.Ada.AdaHeaderFooterList;
 ...
 * @param <E>
 */
public abstract class FragItemList<E> extends RoboSherlockFragment
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case id.notifications:
            startActivity(new Intent(getActivity(),ActNotifications.class));
            return true;
        case R.id.logout:
            logout();
            return true;
...
//                forceRefresh();
     ...
     * {@link DD.Android.Zhaohai.ui.ThrowableLoader}
     *
     * @param loader
     ...
     */
    protected FragItemList<E> setListAdapter(final ListAdapter adapter) {
        if (listView != null)
            listView.setAdapter(adapter);
        return this;
    }

    private FragItemList<E> fadeIn(final View view, final boolean animate) {
        if (view != null)
            if (animate)
    ...
    private FragItemList<E> show(final View view) {
        ViewUtils.setGone(view, false);
        return this;
    }

    private FragItemList<E> hide(final View view) {
     ...
     * @return this fragment
     */
    public FragItemList<E> setListShown(final boolean shown) {
     ...
     * @return this fragment
     */
    protected FragItemList<E> setEmptyText(final String message) {
        if (emptyView != null)
     ...
     * @return this fragment
     */
    protected FragItemList<E> setEmptyText(final int resId) {
        if (emptyView != null)
