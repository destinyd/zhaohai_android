...
//            return false;
        switch (item.getItemId()) {
            case R.id.menu_refresh:
                progressDialogShow(ActActivity.this);
                new GetActivityTask().execute();
                return true;
            case R.id.menu_join:
                show_join_dialog();
...
//                startActivity(new Intent(this, ActActivityRequests.class).putExtra(ACTIVITY, activity));
                return true;
            default:
    ...
    private void to_invite_friend() {
        startActivity(new Intent(this, ActInviteFriend.class).putExtra(ACTIVITY, activity));
    }
    ...
    private void show_join_dialog() {
        ...
        v_alert_message = inflater.inflate(R.layout.dialog_edittext, null);
