 ...
 * @param <E>
 */
public class AdaHeaderFooterList<E extends BaseAdapter> extends
     ...
     * @param adapter
     */
    public AdaHeaderFooterList(ListView view, E adapter) {
        this(new ArrayList<FixedViewInfo>(), new ArrayList<FixedViewInfo>(),
                view, adapter);
    }

    private AdaHeaderFooterList(ArrayList<FixedViewInfo> headerViewInfos,
     ...
     * @return this adapter
     */
    public AdaHeaderFooterList<E> addHeader(View view) {
     ...
     * @return this adapter
     */
    public AdaHeaderFooterList<E> addHeader(View view, Object data,
     ...
     * @return this adapter
     */
    public AdaHeaderFooterList<E> addFooter(View view) {
     ...
     * @return this adapter
     */
    public AdaHeaderFooterList<E> addFooter(View view, Object data,
            boolean isSelectable) {
        FixedViewInfo info = list.new FixedViewInfo();
        info.view = view;
        info.data = data;
