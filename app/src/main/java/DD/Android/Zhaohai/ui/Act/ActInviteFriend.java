...
import DD.Android.Zhaohai.ui.Ada.AdaDispatchSelectUsers;
...
public class ActInviteFriend extends ActZhaohai {
...
//            return false;
    ...
    private void initListData(List<User> personList) {
        AdaDispatchSelectUsers adapter = new AdaDispatchSelectUsers(
                this, personList,
    ...
    private class GetFriendTask extends AsyncTask<Void, String, Void> {
        protected void onPreExecute () {//在 doInBackground(Params...)之前被调用，在ui线程执行
            progressDialogShow(ActInviteFriend.this);
        }
