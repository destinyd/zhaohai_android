...
public class ActivityNotifications extends ZhaohaiActivity {
...
//                invite_friend();
    ...
    private void initListData(List<ZNotification> requests) {
        DispatchNotificationAdapter adapter = new DispatchNotificationAdapter(
                this, requests,
                R.layout.dispatch_notification_item);
    ...
    private class GetNotifications extends AsyncTask<Void, String, Void> {
        ...
        protected void onPreExecute () {//在 doInBackground(Params...)之前被调用，在ui线程执行
            progressDialogShow(ActivityNotifications.this);
        }
