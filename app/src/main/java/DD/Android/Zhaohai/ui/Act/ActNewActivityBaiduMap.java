...
import DD.Android.Zhaohai.ui.Ada.AdaMKSuggestionResults;
import DD.Android.Zhaohai.ui.ZhaohaiPoiOverlay;
...
public class ActNewActivityBaiduMap extends ActZhaohai {
    ...
    static public ActNewActivityBaiduMap factory = null;
...
//    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_new_activity_baidu_map);
...
//                    Toast.makeText(ActNewActivityBaiduMap.this, title, Toast.LENGTH_SHORT).show();
//                }
            }
        };
        ...
        mSearch.init(ZhaohaiApplication.getInstance().mBMapManager, new MKSearchListener() {
            ...
            public void onGetPoiResult(MKPoiResult mkPoiResult, int type, int error) {
                ...
                if(mkPoiResult != null && mkPoiResult.getNumPois() > 0){
                    ZhaohaiPoiOverlay poiOverlay = new ZhaohaiPoiOverlay(ActNewActivityBaiduMap.this, mMapView, mSearch);
                    ...
                    strInfo += "找到结果";
//                    Toast.makeText(ActNewActivityBaiduMap.this, strInfo, Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onGetSuggestionResult(MKSuggestionResult mkSuggestionResult, int i) {
                if (i != 0 || mkSuggestionResult == null || mkSuggestionResult.getSuggestionNum() == 0) {
                    Toast.makeText(ActNewActivityBaiduMap.this, "抱歉，未找到结果", Toast.LENGTH_LONG).show();
                    return;
                }
...
//                }
//                ArrayAdapter<String> suggestionString = new ArrayAdapter<String>(ActNewActivityBaiduMap.this, android.R.layout.simple_list_item_1,mStrSuggestions);
...
//                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, R.layout.list_item, COUNTRIES);
                AdaMKSuggestionResults suggestion_adapter =
                        new AdaMKSuggestionResults(
                                ActNewActivityBaiduMap.this,
...
//                Toast.makeText(ActNewActivityBaiduMap.this, "suggestion callback", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onGetPoiDetailSearchResult(int i, int error) {
//                if (error != 0) {
//                    Toast.makeText(ActNewActivityBaiduMap.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
//                }
//                else {
//                    Toast.makeText(ActNewActivityBaiduMap.this, "成功，查看详情页面", Toast.LENGTH_SHORT).show();
//                }
            }
        });
...
//        if(locData.latitude !=0.0 && locData.longitude !=0.0){
    ...
    public void select(MKPoiInfo info) throws Exception{
...
//        }
    ...
    private class CreateActivityTask extends AsyncTask<Void, String,Void> {
        ...
        protected void onPreExecute() {
            progressDialogShow(ActNewActivityBaiduMap.this);
...
//            printInfo("onPostExecute");
            if(activity.get_id() != null){
                startActivity(new Intent(ActNewActivityBaiduMap.this, ActActivity.class).putExtra(ACTIVITY, activity));
                finish();
            }
//            Toast.makeText(ActNewActivityBaiduMap.this, "Done!", Toast.LENGTH_SHORT).show();
//            ActNewActivityBaiduMap.this
        }
    }
