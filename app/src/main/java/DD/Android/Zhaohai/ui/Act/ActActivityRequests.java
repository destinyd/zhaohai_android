...
import DD.Android.Zhaohai.ui.Ada.AdaDispatchActivityRequests;
...
public class ActActivityRequests extends ActZhaohai {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_activity_requests);
...
//                invite_friend();
    ...
    private void initListData(List<ActivityRequest> personList) {
        AdaDispatchActivityRequests adapter = new AdaDispatchActivityRequests(
                this, requests,
                R.layout.item_activity_requests);
...
//            progressDialogShow(ActActivityRequests.this);
        }
