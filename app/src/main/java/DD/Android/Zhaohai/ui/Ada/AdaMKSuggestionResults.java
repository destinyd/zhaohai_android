 ...
 */
public class AdaMKSuggestionResults extends ArrayAdapter<MKSuggestionInfo>  {
    private ArrayList<MKSuggestionInfo> mData;

//    public AdaMKSuggestionResults(Context context, int textViewResourceId) {
//        super(context, textViewResourceId);
//        mData = new ArrayList<MKSuggestionInfo>();
//    }

    public AdaMKSuggestionResults(Context context, int textViewResourceId, ArrayList<MKSuggestionInfo> pdata) {
        super(context, textViewResourceId);
        if(pdata == null)
