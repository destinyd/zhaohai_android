...
public class FragNewActivity extends FragSimple {
...
//        tp_started_at.setBackgroundColor(Color.BLACK);
        ...
        btn_edit_started_at.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final View textEntryView = inflater.inflate(R.layout.dialog_select_time, null);
//
...
//                dialog =
//                    new DiaSelectTime.Builder(getActivity())
//                            .setTitle(getResources().getString(R.string.set_started_at))
//                            .setIcon(android.R.drawable.ic_dialog_info)
//                            .setNegativeButton(getResources().getString(android.R.string.cancel), null)
//                            .setPositiveButton(getResources().getString(android.R.string.ok), OkClick)
...
//                dialog = DiaSelectTime.getInstant(getActivity());
...
//                                        Toast.LENGTH_LONG)
//                                .show();
                        startActivity(new Intent(getActivity(), ActNewActivityBaiduMap.class).putExtra(ACTIVITY, activity));
//                    }
                }
                else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.act_new_activity, null);
    }
