...
public class UserAuthenticatorService extends Service {
    ...
    private static ZhaohaiAccountAuthenticator AUTHENTICATOR = null;
    ...
    private ZhaohaiAccountAuthenticator getAuthenticator() {
        if (AUTHENTICATOR == null)
            AUTHENTICATOR = new ZhaohaiAccountAuthenticator(this);
